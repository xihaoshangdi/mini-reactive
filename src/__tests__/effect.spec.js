import { effect, stop } from "../lib/reactiveEffect.js";
...
describe('reactivity/effect', () => {
  ...
  // TODO
  xit('should not be triggered when set with the same proxy', () => {
    const obj = reactive({ foo: 1 })
  ...
  xdescribe('readonly + reactive for Map', () => {
